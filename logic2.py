...
def CalculateRisk(entryField, industryDropdown, manufacturerDropdown, typeVariable, cveDesc, categoryList):
    ...
    totalRiskOutput = outputRiskInfo(industryDropdown, actorsList, exploitabilityScore, confidentialityEff, integrityEff, impactScore, formulaRes, numberVuln, searchTermList[searchIndex], typeVariable, verbose)
